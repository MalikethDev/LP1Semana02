...
namespace IfExample
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            // Testar o if
            if (shieldsUp && armourOk) // Se os escudos estiverem activos e a armadura estiver intacta
            {
                Console.WriteLine($"You're doing great {smile}");
            }
            else if (shieldsUp ^ armourOk) // Se os escudos estiverem activos ou a armadura estiver intacta
            {
